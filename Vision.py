...
PROJECT_NAME = "Gabriel" # Because, during early development, the program read a "71" instead of a "74" on plate N°9, being colorlind in the same way as Gabriel, my boyfriend.
